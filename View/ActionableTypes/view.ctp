...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-12">
		...
		<td>
			<?php echo h($actionType['ActionType']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Name'); ?></strong></td>
		<td>
			<?php echo h($actionType['ActionType']['name']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Description'); ?></strong></td>
		<td>
			<?php echo h($actionType['ActionType']['description']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
		...
		<th><?php echo __('Action Type Id'); ?></th>
		...
		<th><?php echo __('Deleted'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($actionType['Task'] as $task): ?>
		<tr>
			<td><?php echo $task['id']; ?></td>
			<td><?php echo $task['task_type_id']; ?></td>
			<td><?php echo $task['action_type_id']; ?></td>
			...
			<td><?php echo $task['action_date']; ?></td>
