...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-12">
		...
		<div class="taskColors view">

			<h2><?php  echo __('Task Color'); ?></h2>
		...
		<td>
			<?php echo h($taskColor['TaskColor']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Name'); ?></strong></td>
		<td>
			<?php echo h($taskColor['TaskColor']['name']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Code'); ?></strong></td>
		<td>
			<?php echo h($taskColor['TaskColor']['code']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
		...
		<th><?php echo __('Deleted'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($taskColor['Task'] as $task): ?>
		<tr>
