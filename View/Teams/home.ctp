<?php 
    ...
    $this->Js->buffer("
        ...
        $('#duesoon_task_link').on('click', function(){
            $('html, body').animate({
                scrollTop: $('#due_soon').offset().top}+60, 800);
                return false;
        });
        ...
        $('#open_task_link').on('click', function(){
            $('html, body').animate({
                scrollTop: $('#open_req').offset().top}, 800);
                return false;
        });

        $('#waiting_task_link').on('click', function(){
            $('html, body').animate({
                scrollTop: $('#waiting_req').offset().top
                }, 
                800
            );
            return false;
...
<div class="row">
    <div class="col-md-4">
        ...
        <ul class="nav nav-pills nav-stacked">
            <li>
                <a id="duesoon_task_link" href="#"><h4><i class="fa fa-bell-o fa-fw"></i>&nbsp; <?php echo ($team_code)?:'';?> Upcoming</span></h4>
                    Upcoming tasks, or those ending or due within the next 2 weeks.
                </a>
            </li>

            <li>
                <a id="open_task_link" href="#"><h4><i class="fa fa-life-saver fa-fw"></i>&nbsp; Requests to <?php echo ($team_code)?:'';?> (Owing) <span class="badge <?php echo ($iOpenReq == 0)? 'badge-yh ': 'badge-danger ';?> pull-right">&nbsp;&nbsp;<?php echo $iOpenReq;?>&nbsp;&nbsp;</span></h4>
                    Tasks where other teams asked for your help and you haven't responded.
                </a>
            </li>
            <li>
                <a id="waiting_task_link" href="#"><h4><i class="fa fa-hourglass-o fa-fw"></i>&nbsp; Requests from <?php echo ($team_code)?:'';?> (Waiting) <span class="badge <?php echo ($iWaitingReq == 0)? 'badge-yh': 'badge-danger';?> pull-right">&nbsp;&nbsp;<?php echo $iWaitingReq;?>&nbsp;&nbsp;</span></h4>
                    Tasks where you asked for help from other teams and you're waiting on a response.
                </a>
            </li>
            <li>
                <a id="team_digest" href="<?php echo $this->Html->url(array('controller'=>'tasks', 'action'=>'digest', $team_id))?>">
        ...
        <div class="col-xs-12">
            <div class="alert alert-info slim-alert">
                <?php echo $this->Form->label('team_id', 'Change Team');?> 
