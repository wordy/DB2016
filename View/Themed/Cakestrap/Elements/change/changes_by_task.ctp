<?php
    ...
    $show_user = false;
    if((isset($userControls) && !empty($userControls)) || AuthComponent::user('user_role_id') == 500){
        $show_user = true;
    }
    //$show_user = true;
   ...
   ?>
            <ul class="pagination xxs-bot-marg">
                    <?php  
                        ...
                        echo '<span id="chgSpinner'.$task.'" class="chgSpinner" style="display: none; margin-left:5px;"><i class="fa fa-cog fa-spin fa-2x"></i></span>';
                    ?>
                </ul><!-- /.pagination -->
        <?php
        endif;
