<?php
    ...
    //$event_date = date('Y-m-d', strtotime(Configure::read('EventDay')));
    ...
    //debug($ishr);
    $rng_start = date('Y-m-d H:i:s',strtotime($event_date)+$ishr*60*60);
    $rng_end = date('Y-m-d H:i:s', strtotime($event_date)+($ishr*60*60)+(59*60)+59);
...
<div class="alert alert-success nofade"><b><i class="fa fa-hand-o-right"></i> Tip: </b>Click on the 5-minute markers to quickly add a task at that time.</div>

    <div class="well">
        <div class="row">
            <div class="col-xs-4 col-sm-5">
                <button class="btn btn-default btn-block <?php echo ($ishr-1 < 6)?'hidden':'';?>" id="btnHrPrevious"><i class="fa fa-arrow-left"></i> <?php echo $prev_hr; echo ($ishr-1<24)? '<span class="hidden-xs"> Event Day <i class="fa fa-diamond"></i></span>':'<span class="hidden-xs"> Day After Event';?></span></button>
            </div>
            ...
            <div class="col-xs-4 col-sm-5">
                <?php if($ishr+1 <> 31):?>
                    <button class="btn btn-success btn-block" id="btnHrNext"><?php echo $next_hr; echo ($ishr+1<24)? '<span class="hidden-xs"> Event Day <i class="fa fa-diamond"></i></span>':'<span class="hidden-xs"> Day After Event';?> <i class="fa fa-arrow-right"></i></span></button>
                <?php endif;?>
            </div>
        </div>
    </div>  
        ...
        <?php $m = 0; ?>
            <div class="row">
                <?php
                    while ($m <= 60) {
                        if($m == 0){
                            echo '<span class="h4 bolder mml00" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':0'.$m.'">'.(date('ga', strtotime($rng_s_time))).'</span>';
                        }
                        elseif($m == 5){
                            echo '<span class="h4 bolder hidden-xs hidden-sm mml0'.$m.'" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':0'.$m.'">'.($rng_s_hr%12).':0'.$m.'</span>';
                        }
                        elseif($m % 10 == 5){
                    ...
                    foreach($tasks as $task){
                        ...
                        if($k == $team){
                            echo '<div class="progress md-bot-marg">';
                                echo '<div data-min="05" class="mm05 tl-mark" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':05"></div><div data-min="10" class="mm10 tl-mark" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':10"></div><div data-min="15" class="mm15 tl-mark tline-markers-q" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':15"></div><div data-min="20" class="mm20 tl-mark" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':20"></div><div data-min="25" class="mm25 tl-mark" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':25"></div><div data-min="30" class="mm30 tl-mark tline-markers-h" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':30"></div><div data-min="35" class="mm35 tl-mark" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':35"></div><div data-min="40" class="mm40 tl-mark" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':40"></div><div data-min="45" class="mm45 tl-mark tline-markers-q" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':45"></div><div data-min="50" class="mm50 tl-mark" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':50"></div><div data-min="55" class="mm55 tl-mark" data-toggle="tooltip" data-placement="top" title="'.$timeline_hr.':55"></div>';
                                echo '<div class="progress-bar no-color" style="width: '.$pos['left_pct'].'%"></div>';
                                echo '<div class="task-len progress-bar '.$tstyles[$c%2].'" style="width: '.$pos['length_pct'].'%">'.$date_txt_a.'</div>';
...
<?php        
    ...
    <div class="well">
        <div class="row">
            <div class="col-xs-4 col-sm-5">
                <button class="btn btn-default btn-block <?php echo ($ishr-1 < 6)?'hidden':'';?>" id="btnHrPrevious2"><i class="fa fa-arrow-left"></i> <?php echo $prev_hr; echo ($ishr-1<24)? '<span class="hidden-xs"> Event Day <i class="fa fa-diamond"></i></span>':'<span class="hidden-xs"> Day After Event';?></span></button>
            </div>
            ...
            <div class="col-xs-4 col-sm-5">
                <?php if($ishr+1 <> 31):?>
                    <button class="btn btn-success btn-block" id="btnHrNext2"><?php echo $next_hr; echo ($ishr+1<24)? '<span class="hidden-xs"> Event Day <i class="fa fa-diamond"></i></span>':'<span class="hidden-xs"> Day After Event';?> <i class="fa fa-arrow-right"></i></span></button>
                <?php endif;?>
            </div>
        </div>
    </div>  
