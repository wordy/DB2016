...
<?php
        ...
        ?>
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <?php echo $this->Ops->subtask($pp['Task'], array('show_view'=>true, 'multi_line'=>false, 'show_offset'=>true)); ?>  
                </div>
            </div>
        <?php 
        endif;
                ...
                <div class="col-xs-<?php echo (12-$level);?>">
                    <?php 
                        if($task['Parent']['id'] && ($task['Task']['time_control']==1)){
                            $relType ='<i class="fa fa-history"></i> <b>Synced To (1 Level Up)</b>' ; 
                        }
                        else{
                            $relType ='<i class="fa fa-link"></i> <b>Linked To (1 Level Up)</b>';
                        }
                    ?>
                    <h5><?php echo $relType;?></h5>
                    <?php echo $this->Ops->subtask($task['Parent'], array('multi_line'=>false, 'show_offset'=>true, 'show_view'=>true)); ?>  
                </div>
            </div>
        <?php $level++; endif; ?>
    ...
    <div class="row" style="padding-bottom: 10px;" >
        ...
        <div class="col-xs-<?php echo (12-$level);?>">
            ...
            <?php 
                echo $this->Ops->subtask($task['Task'], array('multi_line'=>false, 'show_offset'=>true, 'highlight'=>'highlight-thistask'));
                $level++;
            ?>
        </div>
    </div>
                ...
                <div class="row xs-bot-marg">
                    ...
                    <?php 
                        foreach($task['Assist'] as $as){
                            ...
                            echo $this->Ops->subtask($as, array('multi_line'=>false, 'show_offset'=>true, 'show_view'=>true));
                        }
                    ?>
                    </div>
                </div>
